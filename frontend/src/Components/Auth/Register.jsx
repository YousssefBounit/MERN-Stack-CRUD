            ...
            <div style={{width:'360px'}} className='bg-light rounded p-3'>
                ...
                <form onSubmit={hnadleSubmit}>
                    <div className="form-group">
                        ...
                        <input onChange={handleChange} type="text" className="form-control" name="name" placeholder="Enter name" />
                    </div>
                    ...
                    <span className='d-flex justify-content-center'>
                        <Link to={"/auth/login"} style={{borderWidth: "2px",borderColor: "#D2D2D2"}} type="submit" className="btn btn-light w-100 rounded-1">
                            Log-in
                        </Link>
                    </span>            
                </form>
